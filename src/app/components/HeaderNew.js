...
function Header() {
    return (
        <div className="my-2 mx-4 sm:mx-8 lg:mx-12 xl:mx-16 2xl:mx-20 flex flex-col sm:flex-row justify-between items-center">

            <div className="flex items-center">
                <div className="border-2 mx-3 flex justify-center items-center w-[46px] h-[46px] sm:w-[60px] sm:h-[60px] bg-opacity black-4 rounded-[23px]">
                    <Image
                        width={24}
                        height={24}
                        alt="Properx menu"
            ...
            {/* Middle Section */}
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-10 mt-4 sm:mt-0">

                <div className="flex items-center">
                    <input
                        className="w-[300px] sm:w-[400px] bg-defaultwhite rounded-[10px] border border-solid border-opacity black-6 shadow-drop-shadow-normal relative h-[40px] font-paragraph-p3-semi-bold text-neutral-700 whitespace-nowrap p-4 pl-[19px]"
                        placeholder="Search Academy ..."
                        type="text"
                    />

                    <div className="relative bg-slate-100 rounded-[23px] w-[48px] h-[48px] sm:w-[60px] sm:h-[60px] top-0 mx-3">
                    ...
                    <div className="flex items-center bg-slate-100 w-[50px] h-[46px] sm:w-[60px] sm:h-[60px] top-[2px] justify-center bg-opacityblack-4 rounded-[23px]">
                        <Image className="w-[24px] h-[24px] top-[11px] left-[11px]" width={24} height={24} alt="Inbox" src="/static/img/inbox-24-black20.png" />
                    </div>
                </div>

                <div className="border-1 border-solid border-gray-200 h-10 sm:hidden"></div>
                ...
                <div>
                    ...
                    <div className="flex w-[240px] h-[46px] top-[2px] left-[10px]">
                        <div className=" w-[46px]  h-[46px] top-0 left-0 bg-[url(/static/img/avatar-6.png)] bg-cover bg-[50%_50%]">
                            <div className="relative flex items-center justify-center w-[24px] h-[24px] top-[22px] left-[19px] bg-opacitywhite-100 rounded-[12px] shadow-drop-shadow-main">
                                <Image
